...
class ClassList(models.Model):
    ...
    # 一对多和多对多分别加上限制条件(相关部门)limit_choices_to
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name="abc",limit_choices_to={"depart__in": [1002, 1005, 1003, 1004]})
